...
class EventActionCountREST {
  constructor({ Fastify, ActionCountRepository, ProjectValidityRepository }) {
    ...
    const apiUrl = this.fastify.openAPIBaseURL('/private/event/action-count');
    ...
    this.fastify.route({
      ...
      handler: async (req, reply) => {
        ...
        const { body } = req;
        const result = await ActionCountRepository.getActionCount({
          ...body,
...
module.exports = EventActionCountREST;
